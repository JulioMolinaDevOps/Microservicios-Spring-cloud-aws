...
public class ControllerCurso {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> editarCurso(@Valid @RequestBody Cursos curso, BindingResult result,
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(Collections
                            .singletonMap("mensaje",
                                    "No existe el alumno con ese id" + " error en la comunicacion" + e.getMessage()));
    ...
    public ResponseEntity<?> crearalumnocurso(@Valid @RequestBody Alumno alumno, @PathVariable Long cursoid) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(Collections
                            .singletonMap("mensaje", "No se pudo crear el alumno con ese id"
